 ...
 */
define('ERROR_NOTIFY_EMAIL','everjgfeng@gmail.com');	// Where the errors should be emailed
define('ERROR_NOTIFY_FROM_EMAIL','everjgfeng@gmail.com');	// The 'from' address to use in outgoing emails
...
define('ERROR_LOG_FILE','/home/content/a/x/i/axizjoel/html/fakeweb/error_log/my-test-errors.log');		// The full path to your readable + writable error file as defined by PHP config value 'error_log'
